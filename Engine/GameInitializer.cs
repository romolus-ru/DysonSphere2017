...
// заказы должны проверять сколько их и генерировать дополнительные в случае необходимости
// не должно быть что сдвоенный заказ менялся на обычный. должно появиться два заказа
