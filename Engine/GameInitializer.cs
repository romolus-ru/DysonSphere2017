// заказы отделить от планет. будут отдельно. для вывода на экран Orders будет содержать дополнительные данные, уже объединенные - планету и сколько ресурсов на нее ндо перевезти
