// AtlasManager - будет управлять текстурами, загружать, выдавать координаты, всё должно быть спрятано в нём, и база и координаты (для OpenGL)
// добавить к datasupport чтоб оно получало информацию о текстурах
// переделать VisualizationOpenGL что бы он использовал AtlasManager
...
// сделать программу для управления атласами (запись в файл, определение элементов атласа и т.п., узнать какхранят другие программы этуинформацию)
