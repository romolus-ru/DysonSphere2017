// сделать пересчёт геометрии при поворотах (возможно сделать пересчёт на кратное 5 градусам, что бы постоянно не пересчитывать)
// и что бы на экране выводилась геометрия корабля
...
// рендер в текстуру
// если буквы у шрифта будут непонятно как генериться - сделать текстурный шрифт 
