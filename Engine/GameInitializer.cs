// у секций убрать связь с таблицей CollectClass. секция теперь должна хранить имя класса и адрес файла. поэтому эту часть придётся переделать
// перевести ViewJsonWindow на FilteredScrollViewWindow

// интегрировать Jint. основной начальный функционал - возможность загружать код из файлов, формировать методы и выполнять их
// и дополнительная команда для перезагрузки кода из файлов
