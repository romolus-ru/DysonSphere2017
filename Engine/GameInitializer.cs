// Перенести DataSupport обратно в Engine
// AtlasManager - будет управлять текстурами, загружать, выдавать координаты, всё должно быть спрятано в нём, и база и координаты
// на WPF написать програму для редактирования информации о текстурах
