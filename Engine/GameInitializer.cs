// получение команды move to base - неправильно корабли действуют, часто просто телепортируются непонятно куда
// если заказ слетел то выделение планеты остаётся. надо этот момент определять

// докупка 5 кораблей и чтоб они работали и можно было каждый отдельно отозвать
