...
// сделать консоль - просто текстовый режим с курсором и возможностью отлавливать на какой символ нажали, о иде желательно приблизительно функционал Console
// этот режим потом пригодится для имитации консольных режимов и создания сервисных программ работающих в консольном режиме с поддержкой более цветов
