//убрать всю лишнюю индикацию.при выборе точек отправки кораблей лишние точки не должны вообще нажиматься
//перед отправкой корабля проверять можно ли туда отправлять корабль - если заказ не предусматривает какой то ресурс то и незачем туда отправлять корабль
